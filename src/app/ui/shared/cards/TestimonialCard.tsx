...
// TODO: make the card more responsive and add more details like location and role of the person giving the testimonial]
    ...
    <div className="bg-black02 rounded-[1.2rem] border border-grey13 p-[2.4rem] md:p-[3rem] 3xl:p-[4rem] flex flex-col h-full">
      ...
      <div className="flex items-center gap-x-[0.6rem] lg:gap-x-[0.8rem] 3xl:gap-x-[1rem] mb-[1.6rem] md:mb-[2rem] 3xl:mb-[3rem]">
        {Array.from({ length: testimonial.stars }).map((_, index) => (
          <div key={index} className="flex items-center justify-center rounded-full w-[3rem] h-[3rem] md:w-[3.8rem] md:h-[3.8rem] 3xl:w-[4.4rem] 3xl:h-[4.4rem] border border-grey13">
            <Image
              src={StarIcon}
              alt="star"
              height={0}
      ...
      <div className="mt-[1.6rem] md:mt-[2rem] 3xl:mt-[3rem] flex flex-col flex-grow">
        ...
        <p className="urb-m-14 md:text-[1.6rem]! 3xl:text-[1.8rem]! mb-[2rem] md:mb-[2.4rem] 3xl:mb-[3rem]">
          {testimonial.content}
        </p>
